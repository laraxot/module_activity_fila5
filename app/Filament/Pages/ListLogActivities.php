...
abstract class ListLogActivities extends XotBasePage
{
    ...
    public function getBreadcrumb(): string
    {
        ...
        if (is_array($breadcrumb)) {
            return (string) implode(' ', array_map(self::stringifyTranslationValue(...), $breadcrumb));
        }
    ...
    public function getTitle(): string
    {
        ...
        if (is_array($title)) {
            return (string) implode(' ', array_map(self::stringifyTranslationValue(...), $title));
        }
    ...
    protected function sendRestoreSuccessNotification(): Notification
    {
        ...
        $titleString = is_array($title)
            ? (string) implode(' ', array_map(self::stringifyTranslationValue(...), $title))
    ...
    /**
     * Converte in modo sicuro un valore di traduzione (mixed, tipicamente
     * scalare) in stringa, senza cast diretto su mixed.
     */
