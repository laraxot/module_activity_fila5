...
related:
  ...
  - ../../../../Xot/docs/wiki/concepts/<nome progetto>-data-sqlite-pest-bootstrap.md
---
...
Test policy/DB possono fallire se `activity_log` o permessi Spatie non presenti su `<nome progetto>_data.sqlite` — vedi bootstrap Xot `assert<nome progetto>SqliteReadyForTesting()`.
