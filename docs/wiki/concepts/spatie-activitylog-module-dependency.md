...
issues:
  - "https://github.com/laraxot/<repo progetto>/issues/11"
discussions:
...
| Tipo | URL |
|------|-----|
| Issue | https://github.com/laraxot/<repo progetto>/issues/11 |
| Discussion | https://github.com/laraxot/<repo progetto>/discussions/12 |
