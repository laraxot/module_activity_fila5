...
Dipendenze del dominio **Activity** in `Modules/Activity/composer.json`. Il root `laravel/composer.json` resta skeleton; riferimento Ptvx con debito noto — canonico Forecast in [composer-root-minimal-nwidart](../../../../../../docs/wiki/concepts/composer-root-minimal-nwidart.md).
