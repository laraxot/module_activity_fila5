...
Dipendenze del dominio **Activity** in `Modules/Activity/composer.json`. Il root `laravel/composer.json` resta skeleton; riferimento <nome progetto> con debito noto — canonico Predict in [composer-root-minimal-nwidart](../../../../../../docs/wiki/concepts/composer-root-minimal-nwidart.md).
