...
Tracciamento eventi utente/modello (audit log) per <nome progetto> e piattaforma. Business: **sapere chi ha fatto cosa e quando** senza duplicare logica in ogni modulo.
