---
title: "Queueable Actions — Activity Module"
type: concept
created: 2026-07-12
updated: 2026-07-12
confidence: high
tags: [queueable-action, spatie, architecture, laraxot, activity]
related:
  - Modules/Xot/docs/queueable-actions.md
---

# Queueable Actions — Activity Module Doctrine
...
```bash
cd laravel
php -d memory_limit=2048M vendor/bin/phpstan analyse Modules/Activity --no-progress
vendor/bin/pint Modules/Activity/app/Actions
```
