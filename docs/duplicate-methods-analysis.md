...
- `Activity::user` - [Modules/Ptvx/app/Models/Activity.php:58](Modules/Ptvx/app/Models/Activity.php) (Modulo: Ptvx)
- `PushSubscription::user` - [Modules/Ptvx/app/Models/PushSubscription.php:64](Modules/Ptvx/app/Models/PushSubscription.php) (Modulo: Ptvx)
- `Ticket::user` - [Modules/Ptvx/app/Models/Ticket.php:572](Modules/Ptvx/app/Models/Ticket.php) (Modulo: Ptvx)
- `TicketActivity::user` - [Modules/Ptvx/app/Models/TicketActivity.php:78](Modules/Ptvx/app/Models/TicketActivity.php) (Modulo: Ptvx)
- `TicketComment::user` - [Modules/Ptvx/app/Models/TicketComment.php:68](Modules/Ptvx/app/Models/TicketComment.php) (Modulo: Ptvx)
- `TicketHour::user` - [Modules/Ptvx/app/Models/TicketHour.php:62](Modules/Ptvx/app/Models/TicketHour.php) (Modulo: Ptvx)
- `TicketSubscriber::user` - [Modules/Ptvx/app/Models/TicketSubscriber.php:51](Modules/Ptvx/app/Models/TicketSubscriber.php) (Modulo: Ptvx)
...
- `TicketCacheService::getStatistics` - [Modules/Ptvx/app/Services/TicketCacheService.php:42](Modules/Ptvx/app/Services/TicketCacheService.php) (Modulo: Ptvx)
...
- `Activity::casts` - [Modules/Ptvx/app/Models/Activity.php:50](Modules/Ptvx/app/Models/Activity.php) (Modulo: Ptvx)
- `BaseModel::casts` - [Modules/Ptvx/app/Models/BaseModel.php:47](Modules/Ptvx/app/Models/BaseModel.php) (Modulo: Ptvx)
- `BasePivot::casts` - [Modules/Ptvx/app/Models/BasePivot.php:49](Modules/Ptvx/app/Models/BasePivot.php) (Modulo: Ptvx)
- `Category::casts` - [Modules/Ptvx/app/Models/Category.php:117](Modules/Ptvx/app/Models/Category.php) (Modulo: Ptvx)
- `Faq::casts` - [Modules/Ptvx/app/Models/Faq.php:63](Modules/Ptvx/app/Models/Faq.php) (Modulo: Ptvx)
- `FaqCategory::casts` - [Modules/Ptvx/app/Models/FaqCategory.php:67](Modules/Ptvx/app/Models/FaqCategory.php) (Modulo: Ptvx)
- `PushSubscription::casts` - [Modules/Ptvx/app/Models/PushSubscription.php:58](Modules/Ptvx/app/Models/PushSubscription.php) (Modulo: Ptvx)
- `Ticket::casts` - [Modules/Ptvx/app/Models/Ticket.php:188](Modules/Ptvx/app/Models/Ticket.php) (Modulo: Ptvx)
- `TicketCategory::casts` - [Modules/Ptvx/app/Models/TicketCategory.php:51](Modules/Ptvx/app/Models/TicketCategory.php) (Modulo: Ptvx)
...
- `ChangeStatus::execute` - [Modules/Ptvx/app/Actions/ChangeStatus.php:12](Modules/Ptvx/app/Actions/ChangeStatus.php) (Modulo: Ptvx)
- `GenerateTicketsAction::execute` - [Modules/Ptvx/app/Actions/GenerateTicketsAction.php:24](Modules/Ptvx/app/Actions/GenerateTicketsAction.php) (Modulo: Ptvx)
